...
public interface ShareInfoService {
    ...
    void saveShare(ShareInfo shareInfo);

    void delShareBatch(String ShareIds, Integer userId);
    void delShareBatch(String ShareIds, String userId);

    ShareInfo showShareDetailNext(ShareInfoQuery query, Integer currentId, Boolean updateReadCount);
}